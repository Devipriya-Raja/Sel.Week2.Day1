	...
	public class DuplicateLead {
		...
		public static void main(String[] args) {
			// TODO Auto-generated method stub
				...
				WebElement elementDupCompany = driver.findElement(By.id("createLeadForm_companyName"));
				elementDupCompany.clear();
				elementDupCompany.sendKeys("Astra Zen");
				
				WebElement elementDupFirstName = driver.findElement(By.id("createLeadForm_firstName"));
				elementDupFirstName.clear();
				elementDupFirstName.sendKeys("Dev!Pr!y@");
				
				WebElement elementDupSubmitLeadsTab = driver.findElement(By.name("submitButton"));
				elementDupSubmitLeadsTab.click();
